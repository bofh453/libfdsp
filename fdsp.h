...
FDSP_EXPORT void vector_fmul_cf_c(FFTComplex *dst, FFTComplex *src0, float *src1, uint32_t len);
...
FDSP_EXPORT void vector_fmul_add_sse(float *dst, const float *src0, const float *src1,
                         const float *src2, uint32_t len);
FDSP_EXPORT void vector_fmul_cf_sse(FFTComplex *dst, FFTComplex *src0, float *src1, uint32_t len);
...
FDSP_EXPORT void vector_fmul_add_neon(float *dst, const float *src0, const float *src1,
                          const float *src2, uint32_t len);
FDSP_EXPORT void vector_fmul_cf_neon(FFTComplex *dst, FFTComplex *src0, float *src1, uint32_t len);
...
FDSP_EXPORT void sbr_ldqmf_pre_shuffle_sse(float *z);
FDSP_EXPORT void sbr_qmf_post_shuffle_sse(FFTComplex W[32], float *z);
FDSP_EXPORT void sbr_qmf_post_shuffle_avx(FFTComplex W[32], float *z);
FDSP_EXPORT void sbr_qmf_deint_bfly_sse(float *v, const float *src0, const float *src1);
FDSP_EXPORT void sbrenc_qmf_deint_bfly_sse(float *v, const float *src0, const float *src1);
...
FDSP_EXPORT void sbr_qmf_synthesis_window_sse(float *out, float *v, float *sbr_qmf_window);
FDSP_EXPORT void sbr_qmf_synthesis_window_ds_sse(float *out, float *v, float *sbr_qmf_window);
...
FDSP_EXPORT void sbr_ldqmf_pre_shuffle_neon(float *z);
...
FDSP_EXPORT void sbrenc_qmf_deint_bfly_neon(float *v, const float *src0, const float *src1);
...
FDSP_EXPORT void sbr_qmf_synthesis_window_neon(float *out, float *v, float *sbr_qmf_window);
FDSP_EXPORT void sbr_qmf_synthesis_window_ds_neon(float *out, float *v, float *sbr_qmf_window);
...
FDSP_EXPORT void conv_fltp_to_flt_2ch_sse(float *__restrict dst, float *__restrict src[2], unsigned int len);
FDSP_EXPORT void conv_flt_to_fltp_2ch_sse(float *__restrict dst[2], float *__restrict src, unsigned int len);
FDSP_EXPORT void conv_s16p_to_s16_2ch_sse(short *__restrict dst, short *__restrict src[2], unsigned int len);
FDSP_EXPORT void conv_s16_to_s16p_2ch_sse(short *__restrict dst[2], short *__restrict src, unsigned int len);

FDSP_EXPORT void conv_fltp_to_flt_2ch_neon(float *__restrict dst, float *__restrict src[2], unsigned int len);
FDSP_EXPORT void conv_flt_to_fltp_2ch_neon(float *__restrict dst[2], float *__restrict src, unsigned int len);
FDSP_EXPORT void conv_s16p_to_s16_2ch_neon(short *__restrict dst, short *__restrict src[2], unsigned int len);
FDSP_EXPORT void conv_s16_to_s16p_2ch_neon(short *__restrict dst[2], short *__restrict src, unsigned int len);
